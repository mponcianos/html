discurso = '''Senhor Presidente da Assembleia Geral, Tijjani
Muhammad-Bande,
...
sw = '''a, agora, ainda, alguém, algum, alguma, algumas, alguns, ampla, amplas,
        amplo, amplos, ante, antes, ao, aos, após, aquela, aquelas, aquele, 
        aqueles, aquilo, as, até, através, cada, coisa, coisas, com, como, contra,
        contudo, da, daquele, daqueles, das, de, dela, delas, dele, deles, depois,
        dessa, dessas, desse, desses, desta, destas, deste, deste, destes, deve,
        devem, devendo, dever, deverá, deverão, deveria, deveriam, devia, deviam,
        disse, disso, disto, dito, diz, dizem, do, dos, e, é, ela, elas, ele, eles,
        em, enquanto, entre, era, essa, essas, esse, esses, esta, está, estamos,
        estão, estas, estava, estavam, estávamos, este, estes, estou, eu, fazendo,
        fazer, feita, feitas, feito, feitos, foi, for, foram, fosse, fossem, grande,
        grandes, há, isso, isto, já, la, lá, lhe, lhes, lo, mas, me, mesma, mesmas,
        mesmo, mesmos, meu, meus, minha, minhas, muita, muitas, muito, muitos, na,
        não, nas, nem, nenhum, nessa, nessas, nesta, nestas, ninguém, no, nos, nós,
        nossa, nossas, nosso, nossos, num, numa, nunca, o, os, ou, outra, outras,
        outro, outros, para, pela, pelas, pelo, pelos, pequena, pequenas, pequeno,
        pequenos, per, perante, pode, pude, podendo, poder, poderia, poderiam, podia,
        podiam, pois, por, porém, porque, posso, pouca, poucas, pouco, poucos, primeiro,
        primeiros, própria, próprias, próprio, próprios, quais, qual, quando, quanto,
        quantos, que, quem, são, se, seja, sejam, sem, sempre, sendo, será, serão, seu,
        seus, si, sido, só, sob, sobre, sua, suas, talvez, também, tampouco, te, tem,
        tendo, tenha, ter, teu, teus, ti, tido, tinha, tinham, toda, todas, todavia,
        todo, todos, tu, tua, tuas, tudo, última, últimas, último, últimos, um, uma, umas,
        uns, vendo, ver, vez, vindo, vir, vos, vós'''

sw2 = {'e', 'de', 'a', 'que', 'o', 'em', 'para', 'do', 'da',
           'com', 'um', 'os', 'mais', 'por', 'no', 'na', 'as',
           'como', 'nos', 'sua', 'outros', 'se', 'dos', 'também',
           'todos', 'ao', 'das', 'ou', 'meu', 'pela', 'nossos',
           'nossa', 'nosso', 'entre', 'aos', 'onde', 'ainda',
           'esses', 'já', 'pelo', 'essa', 'qualquer', 'todo',
           'uma', 'seus', 'sem', 'toda', 'mesmo', 'seu',
           'senhoras', 'essas', 'outras', 'aqui', 'isso',
           'alguns', 'nós', 'cada', 'nas', 'agora', 'aqueles',
           'apenas', 'suas', 'quase', 'muito', 'este', 'é',
           'contra', 'ele', 'só', 'assim', 'nem', 'tudo', 'sob',
           'nessa', 'nessas', 'dentro', 'desses', 'mesmos', 'até',
           'às', 'esse', 'eles', 'todas', 'tantos', 'deste',
           'deles', 'antes', 'nossas', 'esta', 'vos', 'isto',
           'tantas', 'conforme', 'disso', 'sempre', 'dela', 'pelas',
           'quanto', 'tanto', 'dado', 'daqueles', 'daquele', 'ela',
           'dentre', 'cerca', 'algo', 'nunca', 'atual', 'dr', 'me',
           'pouco', 'aí', 'estas', 'embora', 'cima', 'lá', 'algumas',
           'vezes', 'muitas', 'além', 'bem', 'àqueles', 'aquilo',
           'outro', 'contudo', 'senhorita', 'desde', 'vários', 'através',
           'aquela', 'poucas', 'eu', 'numa', 'à', '–', "mas", 'senhores'}